[![Runs on Jupyter4NFDI](https://github.com/apawlik/papermill-test-broken-ipynb/actions/workflows/jupyter4nfdi.yml/badge.svg)](https://github.com/apawlik/papermill-test-broken-ipynb/actions/workflows/jupyter4nfdi.yml)

# papermill-test-broken-ipynb
Testing GitHub Actions that use Papermill with a broken ipynb. 
